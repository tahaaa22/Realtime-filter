...
"}")
        ...
        self.z_plane = Figure(self.Zplane_box)
        ...
        self.Clear = QtWidgets.QComboBox(self.preferenceBox)
        self.Clear.setEditable(True)
...
"    padding: 5px 10px;")
        ...
        self.radioButton = QtWidgets.QRadioButton(self.preferenceBox)
        self.radioButton.setObjectName("radioButton")
        self.horizontalLayout_5.addWidget(self.radioButton)
        self.radioButton_2 = QtWidgets.QRadioButton(self.preferenceBox)
...
"")
        ...
        self.Magnitude_graph = Figure(self.magBox)
        ...
        self.Phase_graph = Figure(self.phasebox)
...
"}")
        ...
        spacerItem5 = QtWidgets.QSpacerItem(188, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_16.addItem(spacerItem5)
        self.verticalLayout_11.addLayout(self.horizontalLayout_16)
        self.z_plane_2 = Figure(self.Zplane_box_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Magnitude_graph_2 = Figure(self.mag_box)
        ...
        self.Magnitude_graph_3 = Figure(self.phase_box)
        ...
        self.pushButton_3 = QtWidgets.QPushButton(self.customBox)
        ...
        self.comboBox = QtWidgets.QComboBox(self.filterBox)
        ...
        self.pushButton = QtWidgets.QPushButton(self.filterBox)
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout_18.addWidget(self.pushButton)
        self.pushButton_2 = QtWidgets.QPushButton(self.filterBox)
        ...
        self.real_signal = Figure(self.RealBox)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(88, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_13.addItem(spacerItem9)
        self.gridLayout_3.addLayout(self.horizontalLayout_13, 0, 0, 1, 1)
        self.filtered_signal = Figure(self.FilteredBox)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(20, 88, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Z - Pole"))
        self.label_5.setText(_translate("MainWindow", "Zeros-poles placement"))
        self.label_6.setText(_translate("MainWindow", "Clear"))
        self.Clear.setCurrentText(_translate("MainWindow", "all zeros"))
        self.Clear.setItemText(0, _translate("MainWindow", "all zeros"))
        self.Clear.setItemText(1, _translate("MainWindow", "all poles"))
        self.Clear.setItemText(2, _translate("MainWindow", "clear all"))
        ...
        self.label_14.setText(_translate("MainWindow", "Z - Pole"))
        ...
        self.comboBox.setItemText(5, _translate("MainWindow", "custom"))
...
if __name__ == "__main__":
    ...
    MAESTRO = ApplicationManager.AppManager(ui)
    MainWindow.show()
    sys.exit(app.exec_())
